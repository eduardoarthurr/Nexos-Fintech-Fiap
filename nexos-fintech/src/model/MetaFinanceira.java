...
public class MetaFinanceira {
    ...
    public void registrarTransacaoNaMeta(Transacao transacaoMeta) {
        if (status.equals("Em andamento")) {
            ...
            usuario.setSaldo(usuario.getSaldo() - transacaoMeta.getValorTransacao());

            System.out.println("Transação de " + transacaoMeta.getValorTransacao() + "R$" +" registrada na meta " + nomeMeta + " | Meta: " + getValorObjetivo() + " | Saldo acumulado da meta: " + valorAcumulado + " | Saldo: " + usuario.getSaldo() );
